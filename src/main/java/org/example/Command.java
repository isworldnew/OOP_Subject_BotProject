...
public enum Command {
    ...
    INFO("/info", null) {
        @Override
        String textToChat() { return "/willbefree - Внести информацию в бот, где припарковали автомобиль, и когда уедете. Данная информация будет доступна пользователям бота до тех пор, пока не наступит указанное время. Введённые данные в любой момент можно удалить командой /delete /n/n\n" +
                "\n" +
                "/places - Получите изображение с указанием, где вообще можно встать в шаговой доступности от Политеха/n/n\n" +
                "\n" +
                "/wheretopark - Узнаете, где в скором времени освободится парковочное место/n/n\n" +
                "\n" +
                "/trafficpolicealarm - Некоторые недобросовестные водители оставляют автомобиль вторым рядом на Политехнической улице. Владелец этого бота крайне не поддерживает такое нарушение ПДД. Если же Вы по какой-то причине солидарны с такими автовладельцами, можете попытаться успеть предупредить их о приезде ДПС /n/n \n" +
                "\n" +
                "/blocked - Попробуйте уведомить владельца авто, заблокировавшего вас на парковке/n/n\n" +
                "\n" +
